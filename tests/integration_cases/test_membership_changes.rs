...
mod three_peers_add_voter {
    ...
    fn stable() -> Result<()> {
        ...
        debug!("Advancing existing peers");
        for id in 1..=3 {
            let mut found = false;
        ...
        debug!("Leader begins actively replicating");
        // this way it can see the nodes have applied the entry.
